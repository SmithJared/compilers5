...
public class ASTVisitor extends CminusBaseVisitor<Node> {
    ...
    @Override public AbstractNode visitProgram(CminusParser.ProgramContext ctx) {
    ...
    @Override public AbstractNode visitCompoundStmt(CminusParser.CompoundStmtContext ctx) {
        ...
        CompoundStatement cs = new CompoundStatement(statements, symbolTable);
        symbolTable = symbolTable.getParent();
        return cs;
    }

    @Override public AbstractNode visitExpressionStmt(CminusParser.ExpressionStmtContext ctx) {
    ...
    @Override public AbstractNode visitCall(CminusParser.CallContext ctx) {
